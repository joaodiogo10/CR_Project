...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:user:RandomNumberGenLSFR:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: RandomNumberGenLSFR_0, and set properties
  set RandomNumberGenLSFR_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:RandomNumberGenLSFR:1.0 RandomNumberGenLSFR_0 ]
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net RandomNumberGenLSFR_0_M00_AXIS [get_bd_intf_pins RandomNumberGenLSFR_0/M00_AXIS] [get_bd_intf_pins microblaze_0/S0_AXIS]
  ...
  connect_bd_intf_net -intf_net microblaze_0_M0_AXIS [get_bd_intf_pins RandomNumberGenLSFR_0/S00_AXIS] [get_bd_intf_pins microblaze_0/M0_AXIS]

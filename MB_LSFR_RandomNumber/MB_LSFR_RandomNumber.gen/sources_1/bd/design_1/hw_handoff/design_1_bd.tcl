...
proc create_root_design { parentCell } {
  ...
  # Create instance: LSFR_Random_0, and set properties
  set LSFR_Random_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:LSFR_Random:1.0 LSFR_Random_0 ]
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net LSFR_Random_0_M00_AXIS [get_bd_intf_pins LSFR_Random_0/M00_AXIS] [get_bd_intf_pins microblaze_0/S0_AXIS]
  ...
  connect_bd_intf_net -intf_net microblaze_0_M0_AXIS [get_bd_intf_pins LSFR_Random_0/S00_AXIS] [get_bd_intf_pins microblaze_0/M0_AXIS]
